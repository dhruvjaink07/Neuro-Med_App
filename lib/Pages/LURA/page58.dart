...
class Page58 extends StatefulWidget {
  const Page58({super.key, required this.goToPreviousPage, required this.goToNextPage,});
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration:const BoxDecoration(
          image: DecorationImage(image: AssetImage("assets/Page58/1.png"),fit: BoxFit.contain)
        ),
        child: Column(
