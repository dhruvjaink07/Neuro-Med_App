...
class Page54 extends StatefulWidget {
  const Page54({super.key, required this.goToPreviousPage, required this.goToNextPage,});
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration:const BoxDecoration(
          image: DecorationImage(image: AssetImage("assets/Page54/1.png"),fit: BoxFit.contain)
        ),
        child: Column(
