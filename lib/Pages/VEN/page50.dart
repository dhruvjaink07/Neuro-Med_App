...
class Page50 extends StatefulWidget {
  const Page50({super.key, required this.goToPreviousPage, required this.goToNextPage,});
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration:const BoxDecoration(
          image: DecorationImage(image: AssetImage("assets/Page50/1.png"),fit: BoxFit.contain)
        ),
        child: Column(
