...
class Page51 extends StatefulWidget {
  const Page51({super.key, required this.goToPreviousPage, required this.goToNextPage,});
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration:const BoxDecoration(
          image: DecorationImage(image: AssetImage("assets/Page51/1.png"),fit: BoxFit.contain)
        ),
        child: Column(
