...
class Page55 extends StatefulWidget {
  const Page55({super.key, required this.goToPreviousPage, required this.goToNextPage,});
...
class _Page55State extends State<Page55> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      drawer: MenuDrawer(screenHeight: MediaQuery.of(context).size.height, selectedBrand: 'ATTE',),
      body: Center(
        child: Container(
