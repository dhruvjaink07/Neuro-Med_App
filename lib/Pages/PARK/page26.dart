    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration:const BoxDecoration(
          image: DecorationImage(image: AssetImage("assets/Page26/1.png"),fit: BoxFit.contain)
        ),
        child: Column(
            ...
            Expanded(child: Stack(
              children: [
                 Positioned(
                              ...
                              child: InkWell(
                                onTap: (){
                                  showOverlay(context, "assets/Page26/4.png");
                                },
                                child: Image.asset("assets/Page26/4.png",height: 330,width: 750,fit: BoxFit.fill,))),
                 Positioned(
